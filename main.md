...
# Primary Payload Developer Kit Documentation
...
This is the canonical set of MAVLink messages our
 system supports. This repo shoudl contain any custom messages we implement, any third-pary messages we use (e.g.
 common, Ardupilot), and ideally any message sets we need to be compatible with (e.g. other custom message sets
 ATAK uses)
